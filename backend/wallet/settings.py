...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'wallet_db'),
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'wallet.log'),
            'formatter': 'verbose',
        },
    },
    'loggers': {
...
MONNIFY_BASE_URL = os.environ.get('MONNIFY_BASE_URL', 'https://sandbox.monnify.com/api/v1')
